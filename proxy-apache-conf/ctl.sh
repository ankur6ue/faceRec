...
HTTPD_PIDFILE=/opt/bitnami/apps/faceRec/proxy-apache-conf/logs/httpd.pid

HTTPD="/opt/bitnami/apache2/bin/httpd -f /opt/bitnami/apps/faceRec/proxy-apache-conf/httpd-proxy.conf"
